    ...
    <div className="main">
      ...
      <form className="staff-form" ref={form} onSubmit={sendEmail}>
        <div className="forms">
          ...
          <div>
            <p>4. <span><h4>a,</h4></span> Class to which Admission is sought</p>
         ...
         <div>
          <p>5. <span><h4>a,</h4></span>Nationality</p>
         ...
         <div>
         <p>7. Home Address of father</p>
          <input type="text" name="user_homeadd" required  />
         </div>
         <div style={{marginBottom:"40px"}}>
         <p>8. State to which the parents belong</p>
         ...
         <div>
          <p>9. <span><h4>a,</h4></span>Has the applicant any brothers or sisters<br></br>
         ...
         <div>
         <p>10. Will the pupil stay with parents or gardian, if<br></br>
