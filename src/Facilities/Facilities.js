...
<div className="faci">
     ...
     data-aos-duration="2000" className="facilitis">
        <div className="faclities-inner">
          <div>
            <p id="inner-p">
            SFS provides economically feasible transportation facility. School transportation services teach time management sill to the children and helps to build a bond between each child.
            </p>
          </div>
          <div>
