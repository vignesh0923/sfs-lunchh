    ...
    <div className="main">
                ...
                <SwiperSlide className="swipe-image">
                  ...
                  <div className="content">
                    ...
                    <p data-aos="zoom-in">
                      ...
                      spark, Framesp metamorphosing. transforming darkness into
                      the light of wisdom. <RiDoubleQuotesR />
                    </p>
                ...
                <SwiperSlide>
                  ...
                  <div className="content">
                    ...
                    <p data-aos="zoom-in">
                      ...
                      through foskring individuality communication and
                      Celebrating
                      <RiDoubleQuotesR />
                    </p>
                    <span data-aos="zoom-in">
      ...
      <div className="event">
        ...
        <div className="eventss">
          ...
          >
            <img src={e1} alt=""></img>
            <span>Desalite Jubalates Annual Day</span>
            <p>
              Under the spotlight, where dreams take flight; Annual day, a
              celebration of our collective might.
            </p>
          </div>
          <div
            className="banner"
